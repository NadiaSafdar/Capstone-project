...
public class Pending_Appointment extends Fragment implements Json_Callback, Comman_Stuff_Interface {
    public static final String SERVICE_NAME = "service_name";
    public static final String IMAGE_URL = "image_url";
    public static final String SERVICE_ID = "serviceID";
    public static final String PRICE = "service_price";
    public static final String TIME_AGO = "service_time";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (view == null) {
            view = inflater.inflate(R.layout.pending_appointment, container, false);
    ...
    private void set_Recyler_View() {
        ...
        try {
            ...
            for (int b = 0; b < jsonArray1.length(); b++) {
                ...
                map.put(Pending_Appointment.STATUS, "1");
    ...
    public void onResume() {
        ...
        if (isView) {
            ...
            Log.d(TAG, "onResume: isview");
        }
        if (progressView.isShown()) {
            Log.d(TAG, "onResume: shown");
        }
    }
}
...
//    JSONArray jsonArray1 = jsonObject.getJSONArray("userbooking");
//            for (int b = 0; b < jsonArray1.length(); b++) {
//        JSONObject jsonItem1 = jsonArray1.getJSONObject(b);
//
//        String strRequestedDate= jsonItem1.getString("requested_date")+" "+jsonItem1.getString("requested_time");
//        String strTime= jsonItem1.getString("timeago");
//
//        JSONArray jsonArray = jsonItem1.getJSONArray("subservices");
...
//        map.put(IMAGE_URL, Network_Stuffs.BASE_URL+jsonItem.getString("image"));
//        // map.put(SERVICE_ID, jsonItem.getString("id"));
//        map.put(PRICE, jsonItem.getString("price"));
//        map.put(TIME, strTime);
//        map.put(DATE, strRequestedDate);
//        map.put(ADDCART_VALUE, "1");
//        list.add(map);
//        }
//        }